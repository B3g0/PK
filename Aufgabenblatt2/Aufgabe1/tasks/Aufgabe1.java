...
public class Aufgabe1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println((int)a*(int)b*(int)c*(int)d*(int)e*(int)f*(int)g*(int)h);

        System.out.println((int)(a+b+c+d+e+f+g+h));

        System.out.println((byte)a+(byte)b+(byte)c+(byte)d+(byte)e+(byte)f+(byte)g+(byte)h);
    }
}
